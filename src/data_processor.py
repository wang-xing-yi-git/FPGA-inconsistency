    ...
    def generate_summary_report(results: List[Dict]) -> Dict:
        ...
        report = {
            'summary': {
                ...
                'average_issues_per_item': total_issues / total_items if total_items > 0 else 0,
                'issue_percentage': (items_with_issues / total_items * 100) if total_items > 0 else 0
            },
